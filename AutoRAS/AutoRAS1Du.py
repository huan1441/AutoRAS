# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#
# Created by Tao Huang, May 2021, in Python 3.7
#
...
def Py2HecRas_1DU_Project(u,p,ProjectName):
    ...
    print("INFO: HEC-RAS 1D unsteady project file for "+ProjectName+" is done!")
...
def Py2HecRas_1DU_Plan(g,u,StartDateTime,EndDateTime,CI="1HOUR",HI="1DAY",MI="1DAY",DI="1DAY",ProjectName="test"):
    ...
    # modify the original project file
    Py2HecRas_1DU_Project(u,pn,ProjectName)
    ...
    print("INFO: HEC-RAS 1D unsteady flow plan file "+ProjectName+" is done!")
...
def Py2HecRas_1DU_Run(ProjectName):
    ...
    try:
        ...
        mylogger.error("**********")
        mylogger.info("INFO: " + Msg3[0] + " for "+ProjectName)
        mylogger.info("INFO: " + Msg3[1] + " successfully!")
        mylogger.error("**********\n")
        mylogger.removeHandler(myhandler)
    ...
    print("INFO: HEC-RAS 1D unsteady flow results for "+ProjectName+" are done!")
